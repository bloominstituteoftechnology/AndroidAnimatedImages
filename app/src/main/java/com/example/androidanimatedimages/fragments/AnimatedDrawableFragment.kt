 ...
 * [AnimatedDrawableFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [AnimatedDrawableFragment.newInstance] factory method to
...
class AnimatedDrawableFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AnimatedDrawableFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AnimatedDrawableFragment().apply {
